...
<svelte:head>
	...
	<meta name="description" content="Synesthetic audio-reactive color palettes" />
</svelte:head>
...
<div
	...
	style="
		background: linear-gradient({gradientAngle}deg,
			hsl({primaryHue}, {primarySaturation}%, {primaryLightness - 20}%) 0%,
			hsl({secondaryHue}, {primarySaturation * 0.8}%, {primaryLightness - 10}%) 50%,
			hsl({accentHue}, {primarySaturation * 0.6}%, {primaryLightness - 15}%) 100%
		);
	"
>
