...
<svelte:head>
	<title>Fluid Blobs — Composer Idea Two</title>
	<meta name="description" content="Blob-shaped UI panels driven by frequency bands" />
</svelte:head>

<div
	class="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white"
>
