...
<svelte:head>
	...
	<meta name="description" content="Adaptive grid layouts that flow with the music" />
</svelte:head>

<div
	class="min-h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-black text-white"
>
