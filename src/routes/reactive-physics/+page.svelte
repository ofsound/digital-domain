...
<svelte:head>
	<title>Reactive Physics</title>
	<meta name="description" content="Matter.js physics simulation with audio reactivity" />
</svelte:head>

<div
	class="min-h-screen overflow-hidden bg-gradient-to-br from-gray-900 via-slate-900 to-black text-white"
>
	<!-- Header -->
