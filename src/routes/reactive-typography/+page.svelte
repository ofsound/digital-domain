<script lang="ts">
	...
	let lyricsRefs: HTMLSpanElement[] = [];
...
<svelte:head>
	<title>Reactive Typography</title>
	<meta name="description" content="Text that breathes with the music" />
</svelte:head>

<div
	bind:this={containerRef}
	class="min-h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"
>
